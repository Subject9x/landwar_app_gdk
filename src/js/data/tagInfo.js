...
const tagInfo = {
   data :[ 
        ...
        },
        {
            ...
            func : (sizeVal) => {return sizeVal * 2;}
        },
        {
            title : 'Battery',
            desc : 'Unit may divide total Ranged DMG up into several attacks at different targets.',
            func : (sizeVal, rangeDamageVal, rangeVal) => {return Math.max(0, ((rangeVal/2) + rangeDamageVal) - sizeVal);}
        },
        {
            title : 'Blink',
            desc : 'This Unit may ignore Overwatch and Terrain during the Movement Phase',
            func : (meleeDamageVal, rangeDamageVal, rangeVal) => {return;/*TODO*/}
        },
        {
            title : 'Brawler',
            desc : 'Must have Melee DMG > 0. May Reroll 2 ATK and 1 DEF dice in Melee Attacks',
            func : (meleeDamageVal) => {return uc_calc_Damage_Melee(meleeDamageVal) * 0.67;},
            reqs : () => {}
        },
        {
            title : 'Cargo',
            desc : 'Unit can instantly Pick Up an object if equal or smaller Size.',
            func : (sizeVal, moveVal, armorVal) => {return Math.max(0,(((moveVal / 2) + armorVal) - (sizeVal*2)));}
        },
        {
            title : 'Charger',
            desc : 'Unit does not provoke Overwatch attacks.',
            func : (sizeVal, moveVal) => {return (sizeVal *2) + (moveVal / 2);}
        },
        {
        ...
        },
        {
            ...
            func : (sizeVal) => {return ((1/sizeVal^2) * 75) + sizeVal;},
            reqs : () => {return 0;/*TODO */}
        },
        {
            title : 'Fearless',
        ...
        },
        {
            ...
            func : (sizeVal, moveVal) => {return Math.max(0, (moveVal / 2)- (sizeVal * 1.25));}
        },
        {
            title : 'Fortification',
            desc : 'Unit may make unlimited overwatch attacks',
            func : (sizeVal, moveVal, rangeDamageVal) => {return Math.max(0, (moveVal - sizeVal)) + (rangeDamageVal / 2);}
        },
        {
            ...
            func : (sizeVal, moveVal) => {return ((1/sizeVal^2) * 10) + (moveVal / 2);}
        },
        {
            title : 'Grappler',
        ...
        },
        {
            ...
            func : (sizeVal, moveVal, evadeVal, armorVal) => {return sizeVal + (armorVal / 2) + ((moveVal + evadeVal) / 2);}
        },
        {
        ...
        },
        {
            ...
            func : (rangeDamageVal, rangeVal) => {return (rangeDamageVal / 2) + (rangeVal / 2)}
        },
        {
            title : 'Inertial Dampners',
            desc : '"When Move is greater than 12", treat this Unit as having moved only 11" in the Combat Phase.',
            func : (sizeVal, moveVal, evadeVal) => {return (sizeVal * 1.25) + ((moveVal + evadeVal) / 2)}
        },
        {
            ...
            func : (moveVal, rangeVal) => {return (moveVal / 2) + (rangeVal / 2);}
        },
        {
            title : 'Jump Jets',
        ...
        },
        {
            ...
            func : (rangeDamageVal) => {return 0 - (uc_calc_Damage_Range(rangeDamageVal)/2);}
        },
        {
        ...
        },
        {
            ...
            func : (meleeDamageVal, rangeDamageVal) => {return (meleeDamageVal * 2) + (rangeDamageVal * 2);}
        },
        {
            title : 'Rank - Green',
        ...
        },
        {
            ...
            func : (sizeVal, moveVal) => {return ((1 / moveVal^2) * 100) + (sizeVal * 1.5);}
        },
        {
            title : 'Self Healing',
            ...
            func : (sizeVal, armorVal) => {return Math.max(0, (armorVal * 2) - sizeVal);}
        },
        {
            title : 'Shapeshifter',
        ...
        },
        {
            ...
            func : (sizeVal, moveVal, rangeDamageVal, rangeVal) => {return Math.max(0, ((rangeDamageVal / 2) + (rangeVal / 2) + (moveVal / 4)) - sizeVal);}
        },
        {
            ...
            func : (sizeVal, moveVal, evadeVal) => {return Math.max(0, ((moveVal / 2) + (evadeVal * 2)) - sizeVal);}
        },
        {
            title : 'Stall Speed',
